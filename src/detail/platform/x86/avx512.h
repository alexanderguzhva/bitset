...
struct VectorizedAvx512 {
    ...
    static bool op_compare_column(
        ...
        return avx512::OpCompareColumnImpl<T, U, Op>::op_compare_column(bitmask, t, u, size);
    }
    ...
    static bool op_compare_val(
        ...
        return avx512::OpCompareValImpl<T, Op>::op_compare_val(bitmask, t, size, value);
    }
    ...
    static bool op_within_range_column(
        ...
        return avx512::OpWithinRangeColumnImpl<T, Op>::op_within_range_column(bitmask, lower, upper, values, size);
    }
    ...
    static bool op_within_range_val(
        ...
        return avx512::OpWithinRangeValImpl<T, Op>::op_within_range_val(bitmask, lower, upper, values, size);
    }
    ...
    static inline bool op_arith_compare(
        ...
        return avx512::OpArithCompareImpl<T, AOp, CmpOp>::op_arith_compare(bitmask, src, right_operand, value, size);
    }
};
