...
struct VectorizedSve {
    ...
    static bool op_compare_column(
        ...
        return sve::OpCompareColumnImpl<T, U, Op>::op_compare_column(bitmask, t, u, size);
    }
    ...
    static bool op_compare_val(
        ...
        return sve::OpCompareValImpl<T, Op>::op_compare_val(bitmask, t, size, value);
    }
    ...
    static bool op_within_range_column(
        ...
        return sve::OpWithinRangeColumnImpl<T, Op>::op_within_range_column(bitmask, lower, upper, values, size);
    }
    ...
    static bool op_within_range_val(
        ...
        return sve::OpWithinRangeValImpl<T, Op>::op_within_range_val(bitmask, lower, upper, values, size);
    }
    ...
    static inline bool op_arith_compare(
        ...
        return sve::OpArithCompareImpl<T, AOp, CmpOp>::op_arith_compare(bitmask, src, right_operand, value, size);
    }
};
