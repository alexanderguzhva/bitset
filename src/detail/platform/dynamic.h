...
struct VectorizedDynamic {
    ...
    static bool op_compare_column(
        ...
        return dynamic::OpCompareColumnImpl<T, U, Op>::op_compare_column(bitmask, t, u, size);
    }
    ...
    static bool op_compare_val(
        ...
        return dynamic::OpCompareValImpl<T, Op>::op_compare_val(bitmask, t, size, value);
    }
    ...
    static bool op_within_range_column(
        ...
        return dynamic::OpWithinRangeColumnImpl<T, Op>::op_within_range_column(bitmask, lower, upper, values, size);
    }
